...
export interface AppSettings {
	...
	study: {
		...
		countdownMode: "gaokao" | "single" | "multi";
...
function hasElectronNtp(): boolean {
	try {
...
const DEFAULT_TIME_SYNC_PROVIDER: "timeApi" | "ntp" = hasElectronNtp() ? "ntp" : "timeApi";
const DEFAULT_TIME_SYNC_URL = "/api/time";
const DEFAULT_NTP_HOSTS =
	"ntp.aliyun.com,time1.cloud.tencent.com,time2.cloud.tencent.com,cn.ntp.org.cn";
...
const DEFAULT_SETTINGS: AppSettings = {
	...
	general: {
		...
		timeSync: {
			enabled: true,
			provider: DEFAULT_TIME_SYNC_PROVIDER,
			httpDateUrl: "/",
			timeApiUrl: DEFAULT_TIME_SYNC_URL,
			ntpHost: DEFAULT_NTP_HOSTS,
			ntpPort: 123,
			manualOffsetMs: 0,
			offsetMs: 0,
